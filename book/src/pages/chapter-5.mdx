...
<div class="highlight-box">
  <strong>Why use this?</strong> It gives the user direct control over movement. If they freeze or panic, releasing the switch stops the scan instead of missing the target as it flies by.
</div>
